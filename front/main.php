                ...
                <tr>
                    ...
                    ?>
                        <td>
                            ...
                            <div>
                                <div><?= $movie['text'] ?></div>
                                <div>分級:<img src="./icon/03C0<?= $movie['level'] ?>.png" style="width:20px;"><?= $level[$movie['level']] ?></div>
                                <div>上映日期:<?= $movie['ondate'] ?></div>
                                <div><button class="introbtn" data-id=<?= $movie['id'] ?>>劇情介紹</button><button class="orderbtn" data-id=<?= $movie['id'] ?>>線上訂票</button></div>
                            </div>
                        </td>
                    <?php
                    }
